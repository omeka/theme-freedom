...
[![release v1.1.0](https://img.shields.io/badge/release-v1.1.0-blue?logo=git)](https://github.com/omeka/theme-freedom/releases/latest)
...
[![PHP v8.1+](https://img.shields.io/badge/PHP-v8.1+-605F8E?logo=php)](https://github.com/omeka/theme-freedom)
...
The color to be used as the theme's primary color. The default value is #cb4b06.

### Theme's Secondary Color
The color to be used as the theme's secondary color. The default value is #394f68.

### Theme's Accent Color
The color to be used as the theme's accent color for links and accents. The default value is #394f68.

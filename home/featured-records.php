        ...
        <div class="featured-records">
            <?php if ($record_ids[$featured_record_types[0]]) : ?>
                ...
                <ul class="featured featured--primary">
                    <?php echo freedom_featured_record_html($featured_record_types[0], $record_ids[$featured_record_types[0]][0], true, $heading_level); ?>
            ...
            <ul class="featured featured--secondary">
                ...
                <?php if ($record_ids[$featured_record_types[1]]) : ?>
                    <!-- Featured Record -->
                    <?php echo freedom_featured_record_html($featured_record_types[1], $record_ids[$featured_record_types[1]][0], false, $heading_level); ?>
                    <?php array_shift($record_ids[$featured_record_types[1]]); ?>
                <?php endif; ?>

                <?php if ($record_ids[$featured_record_types[2]]) : ?>
                    <!-- Featured Record -->
                    <?php echo freedom_featured_record_html($featured_record_types[2], $record_ids[$featured_record_types[2]][0], false, $heading_level); ?>
                <?php endif; ?>
